  ...
  return (
    <div className="cards">
      <div className="card card-action" onClick={() => navigate("/clientes")}>
        <h3>Pacientes</h3>
        <div className="card-value" style={{ color: "var(--color-primary)" }}>+</div>
        <div className="card-label">Cadastrar novo paciente</div>
      </div>
      <div className="card">
        <h3>Agendamentos</h3>
        <div className="card-value" style={{ color: "var(--color-accent)" }}>—</div>
        <div className="card-label">Hoje</div>
      </div>
      <div className="card">
        <h3>Tratamentos</h3>
        <div className="card-value" style={{ color: "var(--color-success)" }}>—</div>
